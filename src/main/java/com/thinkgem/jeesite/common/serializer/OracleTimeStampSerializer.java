...
public class OracleTimeStampSerializer implements ObjectSerializer {
	
	public static final OracleTimeStampSerializer instance = new OracleTimeStampSerializer();
	...
	public void write(JSONSerializer serializer, Object object) throws IOException {
		try {
			...
			SimpleDataFormatSerializer time = new SimpleDataFormatSerializer("yyyy-MM-dd");
